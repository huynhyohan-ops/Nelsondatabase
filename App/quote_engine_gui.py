...
def main():
    ...
    section[data-testid="stSidebar"] {
        background-color: #1f2937;   /* sáng hơn #111827 */
        padding-top: 0.8rem;
    ...
    # ============================================================
    # TOP MENU BAR (cho mobile / “quay về menu” dễ hơn)
    # ============================================================
    menu_options = (
        "Cập nhật & Normalize bảng giá",
        "Dashboard",
    ...
    current_menu = st.session_state.get("main_menu_radio", menu_options[0])
    ...
    # Nút tắt/nhảy nhanh tab (quay về menu chính)
    if go_quote:
        menu_top = "Quote"
    if go_dashboard:
        menu_top = "Dashboard"

    if menu_top != current_menu:
        st.session_state["main_menu_radio"] = menu_top

    # Từ đây trở xuống, dùng 1 biến duy nhất
    menu = menu_top
    ...
    # ============================================================
    # 4) TAB: FOLLOW SHIPMENT (tạm placeholder, sẽ làm DB sau)
    # ============================================================
