...
def main():
    ...
    # ======= GLOBAL CSS – TONE 3 (sáng, slate grey) =======
    st.markdown(
        """
    <style>
    /* Toàn màn */
    ...
    # ============================================================
    # 4) TAB: FOLLOW SHIPMENT (placeholder)
    # ============================================================
    if menu == "Follow Shipment":
        ...
        st.markdown(
            "<div class='section-sub'>Dự kiến hiển thị trạng thái container, ETA, POD, cập nhật từ hãng tàu.</div>",
            unsafe_allow_html=True,
        )
        st.info("Hiện tại chưa gắn data, chỉ là khung để anh phát triển thêm.")
        return
